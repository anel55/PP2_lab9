...
play_button_image = PhotoImage(file=r'C:\pp2\week7\pygame\play_button.png')
pause_button_image = PhotoImage(file=r'C:\pp2\week7\pygame\pause_button.png')
next_button_image = PhotoImage(file=r'C:\pp2\week7\pygame\next_button.png')
previous_button_image = PhotoImage(file=r'C:\pp2\week7\pygame\previous_button.png')

control_frame = Frame(root)
control_frame.pack()

play_button = Button(control_frame, image=play_button_image, borderwidth=0, command=play_music)
pause_button = Button(control_frame, image=pause_button_image, borderwidth=0, comman=pause_music)
